...
from models.common_prune import C3Pruned, SPPFPruned, BottleneckPruned
...
def run_prune(data,
    ...
    for i, layer in model.named_modules():
        ...
        if isinstance(layer, Bottleneck):
            if layer.add:
                ...
                # print('ignore_bn_list',ignore_bn_list)
    ...
    # print('prune_conv_list',prune_conv_list)
    ...
    print('thre',thre)
    # thre=torch.Tensor(np.array(0.5))
   ...
   # print(maskbndict.keys())
    ...
    #     # print(modelstate.keys()[i])
    #     if list(modelstate.keys())[i] not in list(pruned_model_state.keys()):
    #         testlist.append(list(modelstate.keys())[i])
    # print('list',testlist)
